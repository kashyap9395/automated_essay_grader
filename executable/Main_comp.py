...
train_trans.insert(8, "D2", train_trans['D2_temp'].apply(lambda x:x/3))
...
test_trans.insert(8, "D2", test_trans['D2_temp'].apply(lambda x:x/3))
...
dump_results.to_csv("../output/results_with_grade.csv",index=False)     
